...
model_save_path = cfg.bilstm_attention_model_path
metrics_save_path = cfg.metrics_file
loss_fig_path = cfg.bilstm_attention_loss_fig
cm_fig_path = cfg.bilstm_attentin_cm_fig
...
def plot_loss(train_losses, val_losses):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("BiLSTM-Attention Loss Curve")
    plt.legend()
...
def main():
    ...
    print("训练batch数:", len(train_loader))
    ...
    save_metrics("BiLSTM-Attention", test_acc, test_precision, test_recall, test_f1)
    plot_confusion_matrix(test_labels, test_preds, label_names)

    print("=" * 50)
    print("BiLSTM-Attention训练完成")
