...
model_save_path = cfg.bilstm_model_path
metrics_save_path = cfg.metrics_file
loss_fig_path = cfg.bilstm_loss_fig
cm_fig_path = cfg.bilstm_cm_fig
...
def main():
    ...
    save_metrics("BiLSTM", test_acc, test_precision, test_recall, test_f1)
